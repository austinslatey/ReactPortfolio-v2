        ...
        <div className="cardContainer">
            ...
            <div className="card-text">
                ...
                <p>Hello! My name is Austin Slater, and I'm a Full-Stack Web Developer
                    from Minnesota. <br />
                    As a Full-Stack Web Developer, I work on both the
                    ...
                    JavaScript, JQuery, React.js, Node.js, SQL, and more. <br />  Currently, I
                    have the pleasure to be employed as an Instructional Specialist for
                    edX, where I assist students as they gradually learn Web Development.<br /> 
                    I enjoy learning new concepts to further educate myself in Web and
                    Software Development, and thoroughly reading
                    documentation. <br /> 
                    ...
                    meet client needs and solve business problems. <br />
                    In my leisure time,
                    one might discover me fishing in the region referred to as the 'Land of 10,000 Lakes. </p>
                <p>Feel welcome to connect with me on LinkedIn using the icon provided below, should
                    you wish to contact me directly use the mail icon. <br />
